 ...
 *
 * (C) Copyright 2009-2020, by Sandy McGuffog and Contributors.
 *
 ...
 * 12 Jun 2016 : V1.5; update to DNG V1.4 version from circa May 2016, remove XMP dependency
 * 09 Apr 2018 : V1.6; Fix for a rare issue where matrixes are small in one dimension
 * 31 Jul 2018 : V1.7; Support for nonlinear HueSatMaps
 * 19 Sept 2019 : V1.8; Support for DNG V1.5
 * 11 June 2020 : V1.9; Support for DNG V1.5.1
 * 28 Nov 2020 : V1.10; Support for Apple Silicon
 *
 */
...
#endif
			 "\n"
			 "Copyright (c) 2009-2020 Sandy McGuffog\n"
			 "Portions Copyright 2005-2020 Adobe Systems, Inc.\n"
			 "\n"
