...
The DNG SDK and XMP SDK are (C) Copyright 2005-2020 Adobe Inc.
...
1. This was built under VC 2019 for Windows, and XCode 11 for the Mac. The respective
project files are included

2. In order to compile dcpTool, you need to download the Adobe DNG SDK 1.5.1, and compile it

3. In order to recompile the DNG SDK, you will need to:

a) Download the Adobe XMP SDK, as well as the appropriate version of Expat, zlib, MD5 and QTDevWin.
